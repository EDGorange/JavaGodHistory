...
public final class DateUtil {
     ...
     * 耗时
     *
     * @param startTimeMs 开始时间  System.currentTimeMillis()
     * @return
     */
    public static long elapsedTime(long startTimeMs) {
        long diffMs = elapsedTimeMillis(startTimeMs);
        return Math.floorDiv(diffMs, (1000 * 60));
    }
     ...
     * @return
     */
    public static long elapsedTimeMillis(long startTimeMs) {
        long endTimeMs = System.currentTimeMillis();
        long diffMs = Math.subtractExact(endTimeMs, startTimeMs);
        return diffMs;
    }
