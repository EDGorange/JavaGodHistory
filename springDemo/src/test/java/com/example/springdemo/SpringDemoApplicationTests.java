...
class SpringDemoApplicationTests {
    ...
    public static void main2(String[] args) {
        ...
        enhancer.setSuperclass(TargetClass.class); // 设置目标类为父类
        enhancer.setCallback(new CustomInterceptor()); // 设置自定义的方法拦截器
 ...
 class DynamicProxy implements InvocationHandler {//　这个就是我们要代理的真实对象
    ...
    @Override
    public Object invoke(Object object, Method method, Object[] args)throws Throwable{//　　在代理真实对象前我们可以添加一些自己的操作
...
class TargetClass {
    public void doSomething() {
        System.out.println("TargetClass: 执行目标方法");
    }
}
...
class CustomInterceptor implements MethodInterceptor {
    ...
    public Object intercept(Object obj, Method method, Object[] args, MethodProxy proxy) throws Throwable {
        System.out.println("CustomInterceptor: 在目标方法执行前进行一些操作");
        Object result = proxy.invokeSuper(obj, args); // 调用目标方法
        System.out.println("CustomInterceptor: 在目标方法执行后进行一些操作");
        return result;
    }
}
